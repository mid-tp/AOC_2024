...
# Based on several youtube videos from people programming this in other languages.
# Saw someone use a heapq and noticed it was more efficient that looping over the queue the entire
# time naively.
